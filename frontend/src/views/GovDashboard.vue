  ...
  <div class="max-w-3xl mx-auto animate-fade-in-up">
    ...
    <div class="mb-8 border-b border-slate-200 pb-4">
      <div class="flex items-center gap-3 mb-2">
        <span class="bg-gov-light-blue border border-gov-blue/20 text-gov-blue px-3 py-1 rounded text-xs font-bold uppercase tracking-wider">Admin Portal</span>
      </div>
      <h2 class="text-3xl font-bold text-gov-blue tracking-tight">Upload Scheme</h2>
      <p class="text-slate-700 mt-2 text-lg font-medium">Digitize and add new government schemes to the global vector store. Voice AI will immediately learn about this document.</p>
    </div>

    <!-- Success Feedback -->
    <transition name="fade">
      <div v-if="successMessage" class="bg-emerald-50 border border-emerald-200 text-emerald-800 px-4 py-3 rounded mb-6 flex items-center gap-3 shadow-sm">
    ...
    <div class="bg-white rounded-md shadow border border-slate-300 p-8 relative overflow-hidden">
      <!-- Top accent line -->
      <div class="absolute top-0 left-0 right-0 h-1 bg-gov-saffron"></div>

      <form @submit.prevent="handleUpload" class="space-y-6 relative z-10 mt-2">
        ...
        <div class="space-y-2">
          ...
          <input 
            ...
            type="text" 
            required
            class="w-full bg-slate-50 border border-slate-300 rounded px-4 py-3 text-slate-700 focus:ring-1 focus:ring-gov-blue focus:border-gov-blue outline-none transition-shadow shadow-inner"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div class="space-y-2">
            ...
            <select 
              ...
              class="w-full bg-slate-50 border border-slate-300 rounded px-4 py-3 text-slate-700 focus:ring-1 focus:ring-gov-blue focus:border-gov-blue outline-none transition-shadow appearance-none cursor-pointer shadow-inner"
            >
        ...
        <div class="space-y-2">
          ...
          <textarea 
            ...
            required
            rows="4"
            class="w-full bg-slate-50 border border-slate-300 rounded px-4 py-3 text-slate-700 focus:ring-1 focus:ring-gov-blue focus:border-gov-blue outline-none transition-shadow resize-none shadow-inner"
        ...
        <div class="border-2 border-dashed border-slate-300 bg-slate-50 rounded p-8 text-center hover:bg-slate-100 transition-colors cursor-pointer cursor-not-allowed opacity-70">
        ...
        <button 
          ...
          class="w-full bg-gov-blue hover:bg-blue-900 text-white font-bold py-3 px-6 rounded shadow transition-colors flex items-center justify-center gap-2 mt-8 disabled:opacity-70 disabled:cursor-not-allowed"
        >
